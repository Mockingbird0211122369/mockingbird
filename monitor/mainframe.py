...
from monitor.page1 import Ui_Dialog
from monitor.monitorframe import MonitorDialog
from monitor.recognitionframe import CarRecognitionDialog
...
class MainDialog(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.pixmap = QtGui.QPixmap('data/image1.jpg')
        # 设置QLabel的尺寸
    ...
    def goin2(self):
        self.recognitionframe = CarRecognitionDialog()
        self.recognitionframe.show()
        #self.close()
